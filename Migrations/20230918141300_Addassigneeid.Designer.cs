...
namespace TeamManageSystem.Migrations
{
    ...
    [Migration("20230918141300_Addassigneeid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamManageSystem.Models.Account.ClickupAssignees", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClickupTasksid")
                    ...
                    b.HasIndex("ClickupTasksid");

                    b.ToTable("ClickupAssignees");
                });
            ...
            modelBuilder.Entity("TeamManageSystem.Models.Account.ClickupSpace", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TeamManageSystem.Models.Account.ClickupTasks", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TeamManageSystem.Models.Account.StatusInfo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeamManageSystem.Models.Account.ClickupAssignees", b =>
                {
                    b.HasOne("TeamManageSystem.Models.Account.ClickupTasks", null)
                        .WithMany("assignees")
                        .HasForeignKey("ClickupTasksid");
                });

            modelBuilder.Entity("TeamManageSystem.Models.Account.ClickupTasks", b =>
                {
                    b.HasOne("TeamManageSystem.Models.Account.StatusInfo", "status")
                        .WithMany()
